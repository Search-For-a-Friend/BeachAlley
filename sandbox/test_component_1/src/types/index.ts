...
export interface Establishment {
  ...
  gridPosition?: Vector2;  // Grid coordinates
...
export const DEFAULT_CONFIG: GameConfig = {
  canvasWidth: 800,
  canvasHeight: 600,
  spawnInterval: 3000,  // 3 seconds between spawn checks
  spawnProbability: 0.8,  // 80% chance to spawn
  maxGroups: 15,
  groupSpeed: 1.5,  // Grid units per second
